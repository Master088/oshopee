...
<template>
    <div class="">
        ...
        <div class="bg-primary py-1">
            <p class="text-center text-white font-bold text-md">
                🎉 Shop now and get 20% off your first order!
            </p>
        </div>
        <header class="antialiased">
            <nav class="bg-light-gray border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div class="flex flex-wrap justify-between items-center mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
                    <div class="flex lg:w-3/5 items-center">
                        <Link href="/" class="flex mr-4">
                        <img src="../Img/logo.png" class="mr-3 h-10" alt="FlowBite Logo" />
                        </Link>
                        <form action="#" method="GET" class="hidden lg:flex lg:pl-2 flex-grow">
                    ...
                    <div class="flex items-center lg:order-2">
                        <Link href="/login" as="button" type="button"
                            class="bg-primary hover:bg-primary-dark hover:bg-primary-light text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        Login
                        </Link>
                                    ...
                                    <div class="pl-3 w-full">
                                        <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                                            ...
                                            <span class="font-semibold text-gray-900 dark:text-white">Bonnie
                                                Green</span>: "Hey, what's up? All set for the
                                            presentation?"
                                        </div>
        ...
        <div class="p-4 container mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
        ...
        <div class="border-2 border-gray-500 mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
            <slot />
        </div>
                ...
                <div class="container mx-auto px-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div class="flex flex-col items-center md:items-start">
                            <img src="path/to/logo.png" alt="Store Logo" class="h-12 mb-4" />
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li class="mb-2">American Express</li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li class="mb-2">
                                    <a href="#" class="hover:underline">Fashion</a>
                                </li>
                                <li class="mb-2">
                                    <a href="#" class="hover:underline">Home & Garden</a>
                                </li>
                                <li class="mb-2">
                                    <a href="#" class="hover:underline">Toys</a>
                                </li>
                            </ul>
                        </div>
                    </div>
